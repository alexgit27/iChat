...
class ChatsViewController: MessagesViewController {
    ...
    @objc private func cammeraButtonPresed() {
        ...
        StorageService.shared.uploadImageMessage(photo: image, to: chat) { (result) in
            ...
            case .success(let url):
                ...
                FirestoreService.shared.sendMessage(chat: self.chat, message: message) { (result) in
                    ...
                    case .failure(_):
                        self.showAlertController(with: "Erro!r", and: "Can't send photo!")
                    }
                }
            case .failure(let error):
                self.showAlertController(with: "Error!", and: error.localizedDescription)
...
extension ChatsViewController {
    ...
    func configureCameraIcon() {
        ...
        cameraItem.addTarget(self, action: #selector(cammeraButtonPresed), for: .primaryActionTriggered)
